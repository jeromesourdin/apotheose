...
class Auteur
{
     ...
     * Add livres
     *
     * @param \Eni\DemoBundle\Entity\Livre $livres
     * @return Auteur
     */
    public function addLivre(\Eni\DemoBundle\Entity\Livre $livres)
    {
        $this->livres[] = $livres;
     ...
     * @param \Eni\DemoBundle\Entity\Livre $livres
     */
    public function removeLivre(\Eni\DemoBundle\Entity\Livre $livres)
    {
